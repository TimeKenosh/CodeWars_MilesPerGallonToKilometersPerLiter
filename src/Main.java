...
with a 0, it should be rounded off without the 0. So instead of 5.50, we should get 5.5.
...
public class Main {
    public static void main(String[] args) {
        ...
        double mpg = communicator.getMpG("Enter your MpG: ");
        double kph = calculator.mpgToKpH(mpg);
        communicator.resultOut("Result is: ",kph);
        communicator.close();
    }
}
